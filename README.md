...
5. After the Luup restart, go to *Apps > Develop apps > Create device*, enter and submit:
  ...
  * IP Address: **enter the IP address of your Sonos player, if you know it**
  > NOTE: If you enter an IP address, you can skip step 8 below. If you do not know the IP address of your player, leave the field blank--step 8 should find it.
